  ...
  const services = [
    {
      ...
      title: "GPT & Gemini-powered chatbots",
      gradient: "from-purple-500 to-violet-500"
    },
    {
      icon: <Sparkles className="w-6 h-6" />,
      title: "AI content generation and personalization",
      gradient: "from-cyan-500 to-blue-500"
    },
    {
      icon: <Brain className="w-6 h-6" />,
      title: "ML model integration & API handling",
      gradient: "from-green-500 to-emerald-500"
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "AI for automation and internal tools",
      gradient: "from-orange-500 to-red-500"
    },
    {
      icon: <BarChart3 className="w-6 h-6" />,
      title: "Analytics and insights dashboards",
  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-purple-500/30 to-cyan-500/30 rounded-full blur-3xl"
          animate={isMounted ? {
            scale: [1, 1.2, 1],
            rotate: [0, 180, 360]
          } : {}}
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
              ...
              <br />
              <span className="text-white">With Custom AI Solutions</span>
            </h1>
          </motion.div>
          ...
          >
            We help you integrate AI into your app or build new 
            <span className="text-purple-400 font-semibold"> intelligent products</span> from the ground up.
          </motion.p>
          ...
          >
            Need a chatbot, recommendation engine, or AI-driven automation? We help startups and businesses harness AI to improve experiences, save time, and deliver smarter outcomes — using tools like OpenAI, Gemini, and custom models.
          </motion.p>
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <div className="relative p-8 rounded-3xl backdrop-blur-xl bg-gradient-to-r from-purple-500/10 to-cyan-500/10 border border-purple-400/20 max-w-2xl mx-auto">
              <motion.div
                initial={{ rotate: 0 }}
                animate={isMounted ? { rotate: 360 } : {}}
                transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                className="w-16 h-16 mx-auto mb-6 rounded-full bg-gradient-to-br from-purple-600 to-cyan-600 flex items-center justify-center"
              >
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                <span className="bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
                  💸 AI Solutions, Priced Around You
                </span>
              </h2>
          ...
          >
            <div className="text-center">
              ...
              <div className="text-sm text-gray-400">OpenAI Integration</div>
            </div>
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-bold bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
                Gemini
            ...
            <div className="text-center col-span-2 md:col-span-1">
              ...
              <div className="text-sm text-gray-400">Tailored Models</div>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="relative z-10 py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            {...fadeInUp}
            className="relative p-8 rounded-3xl backdrop-blur-xl bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-400/20"
          >
            <motion.div
              initial={{ rotate: 0 }}
              animate={isMounted ? { rotate: 360 } : {}}
            ...
            <div className="grid md:grid-cols-2 gap-4 text-sm">
              <div className="flex items-center gap-2 justify-center md:justify-start">
                ...
                <span>Custom AI training & fine-tuning</span>
              </div>
              <div className="flex items-center gap-2 justify-center md:justify-start">
                <CheckCircle className="w-4 h-4 text-green-400" />
      ...
      <section className="relative z-10 py-32 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-br from-purple-500/20 via-cyan-500/20 to-green-500/20" />
            ...
            <div className="relative z-10">
              <motion.div
                ...
                className="w-20 h-20 mx-auto mb-8 rounded-full bg-gradient-to-br from-purple-600 to-cyan-600 flex items-center justify-center"
              >
...
export default AiDevPricingPage;
